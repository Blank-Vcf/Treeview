...
class PluginTreeviewConfig  extends CommonDBTM {
   ...
   global $CFG_GLPI;
   	$menuname = array();
      $menuname['title']   = __('Tree view', 'treeview');
      $menuname['page']    = '/plugins/treeview/index.php'; ///index.php/site_admin/user/login
   	return $menuname;
   }  
               ...
               if (in_array($r['id'], $nodes)) {
                  ...
                  foreach (self::$types as $type) {
                     ...
                     if ($DB->numrows($result_1)) {
                        ...
                        $getParam = '?is_deleted=0'.'&criteria[0][field]=' .$field_num.
									'&criteria[0][searchtype]=equals&criteria[0][value]=' .$r['id'].
									'&itemtype='.$type;
